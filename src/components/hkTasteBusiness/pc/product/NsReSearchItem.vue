...
export default class InsAdvancedSearch extends Vue {
    ...
    isChecked:boolean = false;// 是否选中节点
    ...
    checkAll (e, attr) {
      ...
      if (e.target.checked) {
        ...
        if (this.searchType === 1) {
          ...
          // });
          // alert(2);
          // alert(this.checkedValue.length + 'sb' + this.checkedValue[0]);
          // if (this.checkedValue.length !== this.defaultSelected.length) {

          // }
          // this.isChecked = this.checkedValue.length !== this.defaultSelected.length;
    ...
    created () {
      if (this.defaultSelected.length) {
        if (this.searchType === 1) {
          ...
          //   alert(this.defaultSelected[0] + 'vs' + this.searchGroup.Id);
          //   if (this.defaultSelected[0] === this.searchGroup.Id) { this.isChecked = true; }
          // }
        }
